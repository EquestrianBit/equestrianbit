...
static const unsigned int MAX_BLOCK_SIZE = 100000;                      // 100KB block hard limit
/** Obsolete: maximum size for mined blocks */
static const unsigned int MAX_BLOCK_SIZE_GEN = MAX_BLOCK_SIZE/2;         // 50KB  block soft limit
