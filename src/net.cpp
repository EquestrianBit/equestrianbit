...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "EquestrianBit " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"bonsaieaters.com", "bonsaieaters.com"},
    {NULL, NULL},
    {NULL, NULL},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. EquestrianBit is probably already running."), addrBind.ToString().c_str());
        else
